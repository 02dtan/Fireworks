...
public class NormalSpark implements Spark {
	...
	public NormalSpark(FireworksPanel parent, double direction, double x, double y, Color c, long lifespan, double maxSpeed) {
